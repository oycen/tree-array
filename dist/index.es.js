    ...
    Tree.prototype.map = function (callback, _path) {
        ...
        return data.map(function (item, index) {
            try {
                ...
                item[_this.options.children] = new Tree(clonedeep(item[_this.options.children]), _this.options).map(callback, _path);
                return callback.call(null, item, __assign({}, _path), data);
            }
            catch (error) {
                throw error;
    ...
    Tree.prototype.filter = function (callback, _path) {
        ...
        return data.filter(function (item, index) {
            try {
                ...
                if (!_this.hasChildren(item))
                    return callback.call(null, item, __assign({}, _path), data);
                item[_this.options.children] = new Tree(clonedeep(item[_this.options.children]), _this.options).filter(callback, _path);
                return callback.call(null, item, __assign({}, _path), data);
            }
            catch (error) {
                throw error;
